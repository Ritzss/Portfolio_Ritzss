...
const DriftWall = ({
  ...
  const tileClass = cx(
    'group/tile relative block flex-none cursor-none outline-none',
  ...
  return (
    ...
    >
      <div
        ref={planeRef}
        className="absolute left-1/2 top-1/2 flex cursor-none flex-row transform-3d origin-[50%_50%] will-change-transform"
      >
